...
* 
* Modifications by Julius Luukko 2003-10-14 (Julius.Luukko@lut.fi)
*
* - bug correction #1: now compiles if OS_TASK_SW_HOOK_EN is not defined (when using OS_VERSION < 260)
* - bug correction #2: added conditional compilation around OSTaskStatHook (OS_CPU_HOOKS_EN > 0)
*
**********************************************************************************************************
*/
...
*********************************************************************************************************
*/
#if (OS_CPU_HOOKS_EN > 0) && (OS_VERSION < 260 || OS_TASK_SW_HOOK_EN > 0)
...
*********************************************************************************************************
*/
#if (OS_CPU_HOOKS_EN > 0) && (OS_VERSION < 260 || OS_TIME_TICK_HOOK_EN > 0)
