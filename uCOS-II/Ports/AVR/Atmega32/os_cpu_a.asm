...
;
; Modifications by Julius Luukko 2003-09-11 (Julius.Luukko@lut.fi)
;
; - now all subroutine calls use 'rcall' with devices with <= 8 kB of program memory.
;
;
; Modifications by Julius Luukko 2007-11-27 (Julius.Luukko@lut.fi)
;
; - r1 is cleared in OSTickISR before calling OSTimeTick (a function made in C)
;   (a bug discovered by Pavel Hornícek)
;
;********************************************************************************************************
